...
const MURA = (() => {
  ...
  return {
    ...
    location: {
      ...
      cards: [
        { image: `${MR}/7.jpg`, title: 'Президентский парк' },
        { image: `${MR}/8.jpg`, title: '40-й микрорайон Актау' },
        { image: `${MR}/9.jpg`, title: 'Развитая инфраструктура района' },
      ],
      notes: [],
    },
    architecture: {
    ...
    kids: {
      ...
      gallery: [
        { image: `${MR}/7.jpg`, title: 'Безопасные\nматериалы' },
        { image: `${MR}/8.jpg`, title: 'Зона активных\nигр' },
        { image: `${MR}/10.jpg`, title: 'Место для творчества\nи отдыха' },
      ],
    },
    hall: {
      label: 'Холлы',
