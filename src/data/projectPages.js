...
const CENTRAL_PARK = (() => {
  ...
  return {
    ...
    kids: {
      ...
      gallery: [
        { image: `${CP}/sport/workout.webp`, title: 'Workout-зона' },
        { image: `${CP}/sport/football.webp`, title: 'Футбольная площадка' },
        { image: `${CP}/sport/basketball.webp`, title: 'Баскетбольная площадка' },
      ],
      stackRoomLabel: true,
    ...
    hall: {
      ...
      text2: '',
      image: `${MOP}/hall-1.webp`,
      gallery: [
        { image: `${MOP}/hall-2.webp`, title: 'Дизайнерский холл' },
        { image: `${MOP}/hall-3.webp`, title: 'Лифтовой холл' },
        { image: `${MOP}/hall-4.webp`, title: 'Зона ожидания' },
      ],
      // Smart-функции только в блоке квартир — без дублей с холлом.
      features: [
    ...
    consult: {
      ...
      subtitle: 'Менеджер свяжется с вами и подробно расскажет об актуальных коммерческих помещениях.',
...
const MURA = (() => {
  ...
  return {
    ...
    standards: {
      ...
      cards: [
        { image: `${MR}/cam-5.webp`, title: '262 квартир', tall: true },
        { image: `${MR}/cam-2.webp`, title: '3 блока' },
        { image: `${MR}/cam-10.webp`, title: 'Сдача 1 квартал 2028 года' },
      ],
    },
    location: {
      id: `${slug}-location`,
      ...
      cards: [
        { image: `${MR}/cam-3.webp`, title: 'Президентский парк' },
        { image: `${MR}/cam-4.webp`, title: '40-й микрорайон Актау' },
        { image: `${MR}/cam-9.webp`, title: 'Развитая инфраструктура района' },
      ],
      notes: [],
    },
    architecture: {
    ...
    kids: {
      ...
      gallery: [
        { image: `${MR}/cam-8.webp`, title: 'Безопасные\nматериалы' },
        { image: `${MR}/cam-7.webp`, title: 'Зона активных\nигр' },
        { image: `${MR}/cam-6.webp`, title: 'Место для творчества\nи отдыха' },
      ],
    },
    hall: {
