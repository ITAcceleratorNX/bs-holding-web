...
const CENTRAL_PARK = (() => {
  ...
  return {
    ...
    location: {
      ...
      cards: [
        { image: `${R2}/DJI_20250710091110_0765_D-2.webp`, title: 'Гипермаркет Dina', text: 'Гипермаркет Dina — один из крупнейших современных гипермаркетов Актау, где представлен широкий выбор продуктов, товаров для дома и готовой продукции собственной кулинарии.' },
        { image: `${R2}/DJI_20250710091112_0766_D-2.webp`, title: 'Президентский парк', text: 'Президентский парк — один из масштабных парков города, созданный для прогулок, отдыха на свежем воздухе и комфортного семейного времяпрепровождения.' },
        { image: `${R2}/DJI_20250710091117_0767_D-2.webp`, title: 'Музей им. Абиша Кекилбаева', text: 'Музей имени Абиша Кекилбаева — современное культурное пространство, посвящённое жизни, творчеству и наследию выдающегося казахстанского писателя и государственного деятеля.' },
      ],
      notes: [
